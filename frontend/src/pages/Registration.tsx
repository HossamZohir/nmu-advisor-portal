                  ...
                  <div key={course.id}
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="flex-shrink-0">
                        <span className="text-xs font-bold text-primary bg-red-50 px-2 py-0.5 rounded-lg">
                          {course.code}
                        </span>
                      </div>
        ...
        <div className="w-80 flex-shrink-0 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-2xl border border-border overflow-hidden flex-1">
            <div className="px-5 py-4 border-b border-border">
              ...
              <p className="text-muted text-xs mt-0.5">{registration?.courses.length || 0} courses selected</p>
            </div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <label key={flag.key} className="flex items-center gap-3 cursor-pointer">
                    <div
                      onClick={() => updateFlags(flag.key, !flag.checked)}
                      className="w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all cursor-pointer flex-shrink-0"
                      style={{
                        background: flag.checked ? '#8B141E' : 'white',
                        borderColor: flag.checked ? '#8B141E' : '#E5E5E5'
                      }}
                    >
                      {flag.checked && (
          ...
          {successMsg && (
            <div className="bg-green-50 border border-green-200 rounded-xl px-4 py-3 text-green-700 text-xs">
              {successMsg}
            </div>
          )}
          ...
          {isSubmitted && (
            <div className="bg-green-50 border border-green-200 rounded-xl px-4 py-3 text-green-700 text-sm text-center font-semibold">
              ✅ Registration Submitted
            </div>
          )}

          {isLocked && (
            <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-500 text-sm text-center font-semibold">
              🔒 Registration Locked
            </div>
          )}
        </div>
