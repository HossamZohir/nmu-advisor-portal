    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-12 py-16 bg-white">
        <div className="max-w-sm w-full mx-auto animate-fade-in">
          ...
          {/* Heading */}
          <h1 className="text-text text-4xl font-bold mb-2">Academic Portal</h1>
          <p className="text-text-2 text-lg font-normal mb-8">Welcome back!</p>

          {/* Form */}
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="text-text text-sm font-semibold block mb-2">Email address</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="text-text text-sm font-semibold block mb-2">Password</label>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center">
          ...
          <div className="mt-10 pt-8 border-t border-white/10 w-full">
            <p className="text-white/30 text-xs">
              Academic Advisor Portal · بوابة المرشد الأكاديمي
            </p>
          </div>
        </div>
      </div>
